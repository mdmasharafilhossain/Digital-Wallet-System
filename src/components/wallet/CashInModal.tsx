...
import { useCashInMutation } from '../../redux/features/auth/wallet.api';
import type { CashInModalProps} from '../../types/wallet';



const CashInModal: React.FC<CashInModalProps> = ({ isOpen, onClose }) => {
  const [receiverPhone, setReceiverPhone] = useState('');
  const [amount, setAmount] = useState('');
  const [cashInMoney, { isLoading }] = useCashInMutation();
