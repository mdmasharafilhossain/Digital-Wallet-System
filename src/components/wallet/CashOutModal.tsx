...
import {useCashOutMutation } from '../../redux/features/auth/wallet.api';
import type { CashOutModalProps} from '../../types/wallet';
...
const CashOutModal: React.FC<CashOutModalProps> = ({ isOpen, onClose }) => {
  ...
  const [cashOutMoney, { isLoading }] = useCashOutMutation();
